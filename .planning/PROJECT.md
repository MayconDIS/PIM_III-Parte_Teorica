...
- [x] Exportação e integração das Imagens/Diagramas (Protótipos do Figma, Diagramas Astah) para a pasta `assets/`.
- [x] Revisão ortográfica e visual final do documento integrado.
...
| Persona Neutra | UX focado em iniciantes e sem distinção de gênero (Jovem 18-20 anos). | — Done |
